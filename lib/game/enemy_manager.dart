...
class EnemyManager extends Component with HasGameReference<DinoRun> {
  ...
  void onMount() {
    ...
    if (_data.isEmpty) {
      ...
      _data.addAll([
        EnemyData(
          image: game.images.fromCache('spikes.png'),
          nFrames: 1,
          stepTime: 0.1,
          textureSize: Vector2(28, 54),
          speedX: 80,
          canFly: false,
        ),
        EnemyData(
          image: game.images.fromCache('fly.png'),
          nFrames: 1,
          stepTime: 0.1,
        ...
        EnemyData(
          image: game.images.fromCache('run.png'),
          nFrames: 1,
          stepTime: 0.09,
          textureSize: Vector2(59, 38),
          speedX: 150,
          canFly: false,
        ),
      ]);
